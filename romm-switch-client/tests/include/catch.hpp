...
///////////////////////////////////////////////////////////////////////////////
#define OC_MAKE_UNIQUE_NAME( USER_REDACTED, uniqueSuffix ) USER_REDACTED##uniqueSuffix
    ...
    struct CumulativeReporterBase : IStreamingReporter {
        ...
        void sectionStarting( SectionInfo const& sectionInfo ) override {
            ...
            if( m_sectionStack.empty() ) {
                if( !m_USER_REDACTEDSection )
                    m_USER_REDACTEDSection = std::make_shared<SectionNode>( incompleteStats );
                node = m_USER_REDACTEDSection;
            }
            else {
        ...
        void testCaseEnded(TestCaseStats const& testCaseStats) override {
            ...
            node->children.push_back(m_USER_REDACTEDSection);
            m_testCases.push_back(node);
            m_USER_REDACTEDSection.reset();
        ...
        std::shared_ptr<SectionNode> m_USER_REDACTEDSection;
...
namespace Catch {
    ...
    public:
        ...
        void writeSection( std::string const& className,
                           std::string const& USER_REDACTEDName,
...
namespace TestCaseTracking {
    ...
    class TrackerContext {
        ...
        ITrackerPtr m_USER_REDACTEDTracker;
...
namespace Catch {
        ...
        struct GeneratorTracker : TestCaseTracking::TrackerBase, IGeneratorTracker {
            ...
            void close() override {
                ...
                const bool should_wait_for_child = [&]() {
                    ...
                    assert( parent &&
                            "Missing USER_REDACTED (test case) level section" );
    ...
    Totals RunContext::runTest(TestCase const& testCase) {
        ...
        ITracker& USER_REDACTEDTracker = m_trackerContext.startRun();
        assert(USER_REDACTEDTracker.isSectionTracker());
        static_cast<SectionTracker&>(USER_REDACTEDTracker).addInitialFilters(m_config->getSectionsToRun());
        do {
...
namespace TestCaseTracking {
    ...
    ITracker& TrackerContext::startRun() {
        m_USER_REDACTEDTracker = std::make_shared<SectionTracker>( NameAndLocation( "{USER_REDACTED}", CATCH_INTERNAL_LINEINFO ), *this, nullptr );
        m_currentTracker = nullptr;
        m_runState = Executing;
        return *m_USER_REDACTEDTracker;
    }

    void TrackerContext::endRun() {
        m_USER_REDACTEDTracker.reset();
        m_currentTracker = nullptr;
        m_runState = NotStarted;
    }

    void TrackerContext::startCycle() {
        m_currentTracker = m_USER_REDACTEDTracker.get();
        m_runState = Executing;
    }
    ...
    ITracker& TrackerBase::parent() {
        assert( m_parent ); // Should always be non-null except for USER_REDACTED
        return *m_parent;
    }
...
namespace Catch {
    ...
    void JunitReporter::writeTestCase( TestCaseNode const& testCaseNode ) {
        ...
        SectionNode const& USER_REDACTEDSection = *testCaseNode.children.front();
        ...
        writeSection( className, "", USER_REDACTEDSection, stats.testInfo.okToFail() );
    }
    ...
    void JunitReporter::writeSection( std::string const& className,
        ...
        if( !USER_REDACTEDName.empty() )
            name = USER_REDACTEDName + '/' + name;
        ...
        if( !sectionNode.assertions.empty() ||
            ...
            if( className.empty() ) {
                ...
                xml.writeAttribute( "name", "USER_REDACTED" );
            }
            else {
