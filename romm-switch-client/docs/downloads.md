...
- On restart, the app may reuse complete parts (if Range is available); otherwise it starts the ROM over. No per-part manifest/checksum yet; size alone is trusted.
